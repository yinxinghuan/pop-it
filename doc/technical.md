...
- 游戏：Pop It
- 类型：social
- 简述：AlterU 感官 · 指尖泡。一格彩虹硅胶泡，点一下按下去啵一声，按出图案（爱心/笑脸/字母）发到留言墙。看到别人的留言按一下「戳回去」满屏连爆 → 作者收到通知。解压即社交。
...
- 平台元信息：meta.title=Pop It；cover_url=/poster.png；category=social；uuid=0175d24d-fabf-44bb-b848-cee047bbf764
...
- `src/PopIt/types.ts`
- `src/PopIt/index.ts`
- `src/PopIt/PopIt.less`
- `src/PopIt/utils/sounds.ts`
- `src/PopIt/components/Wall.tsx`
